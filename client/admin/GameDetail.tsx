...
class GameDetail extends BaseComponent<
  any,
...
> {
  ...
  componentDidMount() {
    ...
    console.log(
      "DOES CONSTRUCTOR HAVE LOCATION?",
    ...
    if (this.state) {
      return (
        <>
          ...
          >
            ...
            {this.state.Admin.SelectedGame && (
              <>
                <Popup
                  ...
                  trigger={
                    <Button
                      ...
                      icon="edit"
                      onClick={(e) =>
                        this.controller.createOrEditGame(
                          this.state.Admin.SelectedGame
                        )
                      }
                    ></Button>
                ...
                <Header as="h3">
                  <Icon name="calendar" />
                  {this.state.Admin.SelectedGame.DatePlayed}
                </Header>
                <Header as="h3">
                  <Icon name="map" />
                  {this.state.Admin.SelectedGame.Location}
                </Header>
                <Header as="h3">
                  <Icon name="key" />
                  PIN: {this.state.Admin.SelectedGame.GamePIN}
                </Header>
              </>
            )}
          </Segment>
                                              ...
                                              <Dropdown
                                                ...
                                                onChange={(e, output) => {
                                                  ...
                                                  if (playerToAdd) {
                                                    this.state.Admin.SelectedGame.Teams[
                                                      i
                                                    ].Players[j] = playerToAdd;
                                                    this.controller.filterUsersByGame(
                                                      this.state.Admin
                                                        .SelectedGame
                                                    );
                                              ...
                                              <>
                                                ...
                                                <Icon
                                                  ...
                                                  onClick={(e) => {
                                                    this.state.Admin.SelectedGame.Teams[
                                                      i
                                                    ].Players = this.state.Admin.SelectedGame.Teams[
                                                      i
                                                    ].Players.filter(
                                                      (innerP) =>
                                                        p._id != innerP._id
                            ...
                            <Card.Content>
                              ...
                              {t.Players.length < 5 && (
                                <Button
                                  ...
                                  onClick={(e) =>
                                    this.controller.addPlayer(
                                      this.state.Admin.SelectedGame.Teams[i]
                                    )
                                  }
                                ></Button>
                              )}
          ...
          {this.state &&
            this.state.ApplicationState.ModalObject &&
            this.state.ShowTeamDeleteModal && (
              <DeleteTeamModal
