...
export default class GameManagementCtrl extends BaseClientCtrl<IControllerDataStore & { Admin: AdminViewModel, ShowUserModal: boolean, ShowGameModal: boolean, ShowTeamDeleteModal: boolean }>
{
    ...
    public getAllRounds() {
        return SapienServerCom.GetData(null, null, SapienServerCom.BASE_REST_URL + "rounds/with-subrounds").then(r => {
    ...
    public getAllRoundChangeLookups() {
        return SapienServerCom.GetData(null, null, SapienServerCom.BASE_REST_URL + "round-change-lookups").then(r => {
            console.log("GAMES ARE: ", r)
