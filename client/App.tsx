      ...
      return (
        <>
          {location.pathname.indexOf("login") == -1 &&
            this.state &&
            this.state.ApplicationState.CurrentUser &&
            location.pathname.indexOf("slides") == -1 &&
              ...
              >
                {this.state.ApplicationState.CurrentUser.Role ==
                  ...
                  <Menu.Item
                    position="left"
                    onClick={(e) =>
                      (this.controller.dataStore.ApplicationState.ShowMenu = !this
                        .controller.dataStore.ApplicationState.ShowMenu)
                    }
                  >
                    <Icon
                      name={
                        this.state.ApplicationState.ShowMenu ? "cancel" : "bars"
                      }
                    />
                  </Menu.Item>
                )}
                ...
                <Menu.Menu position="right" style={{ padding: "0" }}>
                  {this.state.ApplicationState.CurrentUser.Job !== null &&
                    this.state.ApplicationState.CurrentTeam && (
                      <>
                        <Menu.Item header style={{ paddingRight: 0 }}>
                          {this.state.ApplicationState.CurrentUser.Role !=
                            RoleName.ADMIN && <Icon name="user outline" />}
                        ...
                        {this.state.ApplicationState.CurrentUser.Role !=
                          ...
                          this.state.ApplicationState.CurrentUser.Role !=
                            ...
                            <Menu.Item header style={{ paddingRight: 0 }}>
                              {"Team " +
                                this.state.ApplicationState.CurrentTeam.Number}
                            </Menu.Item>
                          )}
                        ...
                        >
                          ...
                          {(this.state.ApplicationState.CurrentUser.Role ==
                            ...
                            this.state.ApplicationState.CurrentUser.Role ==
                              RoleName.FACILITATOR) &&
                            this.state.ApplicationState.CurrentUser.Role}
                          {GameCtrl.GetInstance().LockedInJob &&
                            " as " + GameCtrl.GetInstance().LockedInJob}
                        </Menu.Item>
                      </>
                    )}
          ...
          <div style={{ height: "100vh" }}>
                              ...
                              <Menu.Item
                                ...
                                onClick={(e) => {
                                  ...
                                  GameCtrl.GetInstance().goToMapping({
                                    ...
                                    ShowFeedback: !this.state.ApplicationState
                                      .ShowFeedback,
                                    ShowRateUsers: false,
                                  });
                                }}
                              ...
                              <Menu.Item
                                ...
                                onClick={(e) => {
                                  ...
                                  GameCtrl.GetInstance().goToMapping({
                                    ...
                                    ChildRound: GameCtrl.GetInstance().getChildRound(),
                                    ShowFeedback: false,
                                    ShowRateUsers: !this.state.ApplicationState
                                      .ShowRateUsers,
                                  });
                                }}
                              ></Menu.Item>
                              <Menu.Item
                                ...
                                onClick={(e) => {
                                  ...
                                  GameCtrl.GetInstance().goToMapping({
                                    ...
                                    ChildRound: GameCtrl.GetInstance().getChildRound(),
                                    ShowFeedback: false,
                                    ShowIndividualFeedback: !this.state
                                      .ApplicationState.ShowIndividualFeedback,
                                  });
                                }}
                              ></Menu.Item>
                            </Menu.Item>
                            ...
                            <Menu.Item>
                                ...
                                onClick={(e) => {
                                  ...
                                  this.setState(
                                    Object.assign(this.state, {
                                      ApplicationState: Object.assign(
                                  ...
                                  (GameCtrl.GetInstance()
                                    .ChildController as BaseRoundCtrl<
                                    any
                                  >).getContentBySubRound();
                              ...
                              <MenuItem
                                ...
                                onClick={(e) => {
                                  ...
                                  console.log(
                                    "BASE CONTROLLER IN APP IS:",
                                    GameCtrl.GetInstance()
                                      .ChildController as BaseRoundCtrl<any>
                                  );
                                      ...
                                      ApplicationState: Object.assign(
                                        this.state.ApplicationState,
                                        {
                                          CurrentUser: Object.assign(
                                            this.state.ApplicationState
                                              .CurrentUser,
                                            { Job: JobName.INTEGRATED_SYSTEMS }
                                          ),
                                        }
                                      ),
                                    })
            ...
            <div
              className={
                "source-stream admin-body " +
                (this.state.ApplicationState.MobileWidth ? "mobile" : "")
              }
            >
              {location.pathname.indexOf("test") != -1 && (
                <h1>THIS IS THE TEST SITE</h1>
              )}
                ...
                {this.state.ApplicationState.CurrentUser &&
                  (this.state.ApplicationState.CurrentUser.Role ==
                    ...
                    this.state.ApplicationState.CurrentUser.Role ==
                      RoleName.FACILITATOR) && (
                    <Route
                      path="/facilitator/slides/:gameid"
                      component={FacilitatorSlides}
                    />
                  )}
              </Switch>
            </div>
          ...
          {this.state.ApplicationState.Toasts && (
            <div className="toast-holder">
              {this.state.ApplicationState.Toasts.filter((t) => !t.Killed).map(
                (t, i) => (
                  <SapienToast key={i} Toast={t} />
                )
              )}
            </div>
          )}
